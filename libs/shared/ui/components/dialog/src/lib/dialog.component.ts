...
@Component({
  ...
  template: `
    ...
    <div class="modal w-screen" #dialog>
      <label class="modal-overlay" #backdrop for="modal-2"></label>
      <div class="modal-content flex max-w-3xl flex-col gap-5">
        <label
          for="modal-2"
...
export class DialogComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    backdropClick$
      ...
      .subscribe(this.dialogRef.backdropClick$);
