...
describe('Listbox', () => {
  ...
  it('should disabled', () => {
    ...
    const clickSingleSpy = spyOn(
      listbox,
      'onOptionClickCheckbox'
    ).and.callThrough();
    fixture.detectChanges();
    ...
    const filterInputEl = fixture.debugElement
      .query(By.css('.p-listbox-filter-container'))
  ...
  it('should call onOptionTouchEnd', () => {
    ...
    const bmwEl = fixture.debugElement.query(By.css('ul')).children[1]
      .nativeElement;
    const onOptionTouchEndSpy = spyOn(
      listbox,
      'onOptionTouchEnd'
    ).and.callThrough();
  ...
  it('should select all', () => {
    ...
    const selectAllEl = fixture.debugElement.query(
  ...
  it('should show filtered items', () => {
    ...
    const filterInputEl = fixture.debugElement.query(
      By.css('.p-listbox-filter-container')
    ...
    expect(
      fixture.debugElement.query(By.css('ul')).nativeElement.children.length
    ).toEqual(2);
  });
  ...
  it('should listen dbClick', () => {
    ...
    const onOptionDoubleClickSpy = spyOn(
      listbox,
      'onOptionDoubleClick'
    ).and.callThrough();
    fixture.detectChanges();
  ...
  it('should select all filtered items', () => {
    ...
    const headerCheckBoxReadonlyEl = fixture.debugElement
      .query(By.css('.p-checkbox.p-component'))
      .query(By.css('input'));
    const headerCheckBoxEl = fixture.debugElement.query(
      By.css('.p-checkbox-box')
    );
    ...
    expect(headerCheckBoxEl.nativeElement.className).not.toContain(
      'p-highlight'
    );
