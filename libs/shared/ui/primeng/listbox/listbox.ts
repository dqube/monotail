...
@Component({
  ...
  template: `
    <div
      [ngClass]="{ 'p-listbox p-component': true, 'p-disabled': disabled }"
      [ngStyle]="style"
      [class]="styleClass"
    >
          ...
          >
            <ng-container *ngIf="allChecked">
              <CheckIcon
                ...
                *ngIf="!checkIconTemplate"
              />
              <span *ngIf="checkIconTemplate" class="p-checkbox-icon">
                <ng-template
                  *ngTemplateOutlet="checkIconTemplate"
                ></ng-template>
              </span>
            </ng-container>
          </div>
          ...
          <div class="p-listbox-filter-container" *ngIf="filter">
            ...
            <SearchIcon
              *ngIf="!filterIconTemplate"
              [styleClass]="'p-listbox-filter-icon'"
            />
        ...
        >
          ...
          <ng-container *ngIf="!group">
            <ng-container
              *ngTemplateOutlet="
                itemslist;
                context: { $implicit: optionsToRender }
              "
            ></ng-container>
          </ng-container>
          <ng-template #itemslist let-optionsToDisplay>
            <li
              *ngFor="let option of optionsToDisplay; let i = index"
              [attr.tabindex]="
                disabled || isOptionDisabled(option) ? null : '0'
              "
              pRipple
              [ngClass]="{
                'p-listbox-item': true,
            ...
            >
              <div
                ...
                *ngIf="checkbox && multiple"
                [ngClass]="{
                  'p-checkbox-disabled': disabled || isOptionDisabled(option)
                }"
              >
                <div
                  class="p-checkbox-box"
...
export class Listbox
  implements AfterContentInit, OnInit, ControlValueAccessor, OnDestroy
{
  /**
   ...
   * @group Emits
   */
  @Output() onChange: EventEmitter<ListboxChangeEvent> =
    new EventEmitter<ListboxChangeEvent>();
  /**
   * Callback to invoke when option is clicked.
   * @param {ListboxClickEvent} event - Custom click event.
   * @group Emits
   */
  @Output() onClick: EventEmitter<ListboxClickEvent> =
    new EventEmitter<ListboxClickEvent>();
  /**
   * Callback to invoke when option is double clicked.
   * @param {ListboxDoubleClickEvent} event - Custom double click event.
   * @group Emits
   */
  @Output() onDblClick: EventEmitter<ListboxDoubleClickEvent> =
    new EventEmitter<ListboxDoubleClickEvent>();
        ...
        (selectedEnabledItemsLength &&
          visibleOptionsLength ===
            selectedEnabledItemsLength +
              ...
              selectedDisabledItemsLength)) as boolean;
    }
  }
      ...
      if (this.group) {
        ...
        for (let optgroup of this.options) {
          ...
          if (filteredSubOptions && filteredSubOptions.length) {
            filteredGroups.push({
              ...optgroup,
              ...{ [this.optionGroupChildren as any]: filteredSubOptions },
            });
          }
        }
        ...
        this._filteredOptions = this._options.filter((option) =>
          (this.filterService as any).filters[this.filterMatchMode](
  ...
  findNextItem(item: HTMLElement): HTMLElement | null {
    ...
    if (nextItem)
      return DomHandler.hasClass(nextItem, 'p-disabled') ||
        ...
        DomHandler.hasClass(nextItem, 'p-listbox-item-group')
  ...
  findPrevItem(item: HTMLElement): HTMLElement | null {
    ...
    if (prevItem)
      return DomHandler.hasClass(prevItem, 'p-disabled') ||
        ...
        DomHandler.hasClass(prevItem, 'p-listbox-item-group')
