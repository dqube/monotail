...
@Component({
  template: `
    ...
    <button
      type="button"
      pButton
      (click)="showAllViaService()"
      label="Use Service"
    ></button>
    <button
      type="button"
      pButton
      (click)="clearWithService()"
      label="Use Service"
    ></button>
    <button
      type="button"
      pButton
      (click)="clearWithServiceAndKey()"
      label="Use Service"
    ></button>
  `,
})
...
describe('Messages', () => {
  ...
  it('should show info', () => {
    ...
    expect(summaryEl).toBeTruthy();
    expect(detailEl).toBeTruthy();
    expect(iconEl.nativeElement.tagName.toLowerCase()).toEqual(
      'infocircleicon'
    );
  ...
  it('should show warning', () => {
    ...
    expect(detailEl.nativeElement.innerHTML).toContain(
