...
@Component({
  template: `<p-tabView>
    <p-tabPanel header="Godfather I" leftIcon="pi pi-calendar">
      ...
      business. T hrough Michael's life the nature of the family business
      becomes clear. The business of the family is just like the head of the
      family, kind and benevolent to those who give respect, but given to
    ...
    <p-tabPanel header="Godfather II" leftIcon="pi pi-inbox">
      ...
      1972 film, The_Godfather parallels the young Vito Corleone's rise with his
      son Michael's spiritual fall, deepening The_Godfather's depiction of the
      dark side of the American dream. In the early 1900s, the child Vito flees
      his Sicilian village for America after the local Mafia kills his family.
      Vito struggles to make a living, legally or illegally, for his wife and
      growing brood in Little Italy, killing the local Black Hand Fanucci after
      he demands his customary cut of the tyro's business. With Fanucci gone,
      Vito's communal stature grows.
    </p-tabPanel>
    <p-tabPanel>
      <ng-template pTemplate="header">Godfather III</ng-template>
      <ng-template pTemplate="content">
        After a break of more than 15 years, director Francis Ford Coppola and
        writer Mario Puzo returned to the well for this third and final story of
        the fictional Corleone crime family. Two decades have passed, and crime
        kingpin Michael Corleone, now divorced from his wife Kay has nearly
        succeeded in keeping his promise that his family would one day be
...
describe('TabView', () => {
  ...
  beforeEach(() => {
    ...
    firstTabPanel = fixture.debugElement.queryAll(By.css('p-tabPanel'))[0]
      .componentInstance;
    secondTabPanel = fixture.debugElement.queryAll(By.css('p-tabPanel'))[1]
      .componentInstance;
    thirdTabPanel = fixture.debugElement.queryAll(By.css('p-tabPanel'))[2]
      .componentInstance;
  ...
  it('should change the header', () => {
    ...
    const firstTabViewNavEl =
      fixture.debugElement.children[0].children[0].children[0].children[0]
        .children[0].children[0].nativeElement;
    const secondTabViewNavEl =
      fixture.debugElement.children[0].children[0].children[0].children[0]
        .children[0].children[1].nativeElement;
  ...
  it('should closable and element count should be 2', () => {
    ...
    tabview.cd.detectChanges();
    const firstTabViewNavEl =
      fixture.debugElement.children[0].children[0].children[0].children[0].query(
        By.css('timesicon')
      ).nativeElement;
    ...
    tabview.cd.detectChanges();
    const tabviewElCount = fixture.debugElement.queryAll(
      By.css('.p-tabview-panel')
    ).length;
  ...
  it('should change left and right icon', () => {
    ...
    tabview.cd.detectChanges();
    const firstTabViewLeftIconEl = fixture.debugElement.query(
      By.css('.p-tabview-left-icon')
    ).nativeElement;
    const firstTabViewRightIconEl = fixture.debugElement.query(
      By.css('.p-tabview-right-icon')
    ).nativeElement;
  ...
  it('should open by activeIndex', () => {
    ...
    const thirdTabViewNavEl =
      fixture.debugElement.children[0].children[0].children[0].children[0]
        .children[0].children[2].nativeElement;
  ...
  it('should change activeIndex', () => {
    ...
    let activeIndex;
    const firstTabViewNavEl = fixture.debugElement.query(
      By.css('.p-tabview-nav-link')
    ).nativeElement;
