...
describe('Breadcrumb', () => {
  ...
  it('should display by default', () => {
    ...
    const breadcrumbEl = fixture.debugElement.query(
      By.css('div')
    ).nativeElement;
  ...
  it('should change home icon', () => {
    ...
    const homeEl = fixture.debugElement
      .query(By.css('.p-breadcrumb-home'))
  ...
  it('should display items', () => {
    ...
    expect(itemsEl.children[2].children[0].nativeElement.textContent).toEqual(
      'Squad'
    );
  ...
  it('should call itemClick when click item ', () => {
    ...
    const itemClickSpy = spyOn(breadcrumb, 'itemClick').and.callThrough();
    const squadEl = fixture.debugElement.query(By.css('ul')).children[2]
  ...
  it('should call itemClick(routerLink) when click item ', () => {
    ...
    const itemClickSpy = spyOn(breadcrumb, 'itemClick').and.callThrough();
    const messiEl = fixture.debugElement.query(By.css('ul')).children[4]
      .children[0].nativeElement;
    messiEl.click();
    fixture.detectChanges();
