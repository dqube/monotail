...
export class RadioControlRegistry {
  ...
  private isSameGroup(
    controlPair: [NgControl, RadioButton],
  ...
  template: `
    ...
    <label
      ...
      [ngClass]="{
        ...
        'p-radiobutton-label-active': rb.checked,
        'p-disabled': disabled,
        'p-radiobutton-label-focus': focused
      }"
      *ngIf="label"
      [attr.for]="inputId"
      >{{ label }}</label
...
export class RadioButton implements ControlValueAccessor, OnInit, OnDestroy {
   ...
   * @group Emits
   */
  @Output() onClick: EventEmitter<RadioButtonClickEvent> =
