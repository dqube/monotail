...
export class PanelMenuSub extends BasePanelMenuItem {
  ...
  getAnimation() {
    return this.expanded
      ? {
          value: 'visible',
          params: { transitionParams: this.transitionOptions, height: '*' },
        }
      : {
          value: 'hidden',
...
@Component({
  ...
  template: `
    <div
      [class]="styleClass"
      [ngStyle]="style"
      [ngClass]="'p-panelmenu p-component'"
    >
