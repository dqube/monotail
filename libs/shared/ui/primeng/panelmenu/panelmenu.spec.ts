...
describe('PanelMenu', () => {
  ...
  it('should change item style styleClass and disable ', () => {
    ...
    const panelHeaderEl = fixture.debugElement.query(
      By.css('.p-panelmenu-header')
    );
  ...
  it('should change item url target item and title', () => {
    ...
    const panelHeaderLinkEl = fixture.debugElement.query(
      By.css('.p-panelmenu-header-link')
    );
    ...
    expect(
      panelHeaderLinkEl.query(By.css('.p-menuitem-icon')).nativeElement
        .className
    ).toContain('Primeng ROCKS!');
  });
  ...
  it('should show items and call toggle', () => {
    ...
    const headerLinks = fixture.debugElement.queryAll(
      By.css('.p-panelmenu-header-link')
    );
    ...
    const firstSubMenuComponent = fixture.debugElement.query(
      By.css('.p-panelmenu-root-submenu')
    ).componentInstance as PanelMenuSub;
  ...
  it('should select multiple', () => {
    ...
    const subMenuEls = fixture.debugElement.queryAll(
      By.css('.p-panelmenu-root-submenu')
    );
    const firstSubMenuComponent = subMenuEls[0]
      .componentInstance as PanelMenuSub;
    const seconSubMenuComponent = subMenuEls[1]
      .componentInstance as PanelMenuSub;
    ...
    for (let activeEl of activeEls) {
      expect(
        activeEl.query(By.css('.p-menuitem-text')).nativeElement.textContent
      ).toEqual(panelmenu.model[x].label);
      x++;
    }
    expect(panelmenu.model[0].expanded).toEqual(true);
  ...
  it('should not select multiple', () => {
    ...
    expect(
      activeEls[0].query(By.css('.p-menuitem-text')).nativeElement.textContent
    ).toEqual(panelmenu.model[1].label);
