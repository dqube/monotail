...
describe('MultiSelect', () => {
  ...
  it('should disabled', () => {
    ...
    const inputReadOnlyEl = fixture.debugElement.query(
      By.css('div')
    ).nativeElement;
    containerEl.click();
    fixture.detectChanges();
  ...
  it('should set dropdown icon by default and able to change', () => {
    ...
    const dropdownIcon = fixture.debugElement.query(
      By.css('.p-multiselect-trigger-icon')
    ).nativeElement;
    ...
    const dropdownIconEl = fixture.debugElement.query(
      By.css('.p-multiselect-trigger-icon')
    );
  ...
  it('should open and close with keydown', () => {
    ...
    let multiselectPanelEl = fixture.debugElement.query(
      By.css('.p-multiselect-panel')
    );
    expect(multiselect.overlayVisible).toEqual(true);
    expect(multiselectPanelEl).toBeTruthy();
  ...
  it('should select item', () => {
    ...
    const multiselectItemEl = fixture.debugElement.queryAll(
      By.css('.p-multiselect-item')
    );
    expect(multiselectItemEl.length).toEqual(10);
    const bmwEl = multiselectItemEl[1];
    const onOptionClickSpy = spyOn(
      multiselect,
      'onOptionClick'
    ).and.callThrough();
  ...
  it('should select item and navigate with keydown', () => {
    ...
    const onOptionKeydownSpy = spyOn(
      multiselect,
      'onOptionKeydown'
    ).and.callThrough();
  ...
  it('should select all', () => {
    ...
    const allCheckedEl = fixture.debugElement.query(
      By.css('.p-checkbox-box')
    ).nativeElement;
    const readOnlyEl = fixture.debugElement.query(By.css('.p-checkbox'))
  ...
  it('should select all when filtered', () => {
    ...
    const onInputFocusSpy = spyOn(
      multiselect,
      'onInputFocus'
    ).and.callThrough();
    const onInputBlur = spyOn(multiselect, 'onInputBlur').and.callThrough();
    const multiselectEl = fixture.debugElement.children[0].nativeElement;
    const readOnlyEl = fixture.debugElement.query(
      By.css('input')
    ).nativeElement;
    readOnlyEl.dispatchEvent(new Event('focus'));
    multiselectEl.click();
  ...
  it('should close with close icon and reset filter input', () => {
    ...
    expect(
      fixture.debugElement.query(By.css('div')).nativeElement.className
    ).not.toContain('p-multiselect-open');
  });
  ...
  it('should display not found message when filter returns 0 results', () => {
    ...
    const visibleItems = fixture.debugElement
      .queryAll(By.css('.p-multiselect-items li'))
      .filter((el) => el.styles.display !== 'none');
    const emptyMesage = fixture.debugElement.query(
      By.css('.p-multiselect-empty-message')
    );
