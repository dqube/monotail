...
export class ButtonDirective implements AfterViewInit, OnDestroy {
  ...
  getStyleClass(): string[] {
    const styleClass: string[] = [
      INTERNAL_BUTTON_CLASSES.button,
      INTERNAL_BUTTON_CLASSES.component,
    ];

    if (
      this.icon &&
      !this.label &&
      ObjectUtils.isEmpty(this.htmlElement.textContent)
    ) {
    ...
    if (this.loading) {
      styleClass.push(
        INTERNAL_BUTTON_CLASSES.disabled,
        INTERNAL_BUTTON_CLASSES.loading
      );
  ...
  updateLabel() {
    let labelElement = DomHandler.findSingle(
      this.htmlElement,
      '.p-button-label'
    );
    ...
    >
      ...
      <ng-container *ngIf="loading">
        <ng-container *ngIf="!loadingIconTemplate">
          <span
            *ngIf="loadingIcon"
            [class]="'p-button-loading-icon' + icon"
            [ngClass]="iconClass()"
          ></span>
          <SpinnerIcon
            *ngIf="!loadingIcon"
            [styleClass]="iconClass() + ' p-button-loading-icon'"
            [spin]="true"
          />
        </ng-container>
