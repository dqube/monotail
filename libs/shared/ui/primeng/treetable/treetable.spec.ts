        ...
        <tr>
          <th *ngFor="let col of cols">
            <input
              ...
              type="text"
              class="filterInput"
              (input)="tt.filter($event.target.value, col.field, filterMode)"
            />
          </th>
        </tr>
      </ng-template>
...
describe('TreeTable', () => {
  ...
  beforeEach(() => {
    ...
    singleSelectionTreeTable =
      fixture.debugElement.children[4].componentInstance;
    multipleSelectionTreeTable =
      fixture.debugElement.children[5].componentInstance;
    checkboxSelectionTreeTable =
      fixture.debugElement.children[6].componentInstance;
  ...
  it('should show 11 rows', () => {
    ...
    const basicTreeTableEl = fixture.debugElement.query(
      By.css('.basicTreeTable')
    );
  ...
  it('should create paginator and 4 rows', () => {
    ...
    const paginationTreeTableEl = fixture.debugElement.query(
      By.css('.paginationTreeTable')
    );
  ...
  it('should sort the treetable', () => {
    ...
    const sortSingleSpy = spyOn(
      basicSortTreeTable,
      'sortSingle'
    ).and.callThrough();
    const basicSortTreeTableEl = fixture.debugElement.query(
      By.css('.basicSortTreeTable')
    );
  ...
  it('should sort the treetable (multiple)', () => {
    ...
    const sortMultipleSpy = spyOn(
      multipleSortTreeTable,
      'sortMultiple'
    ).and.callThrough();
    const multipleSortTreeTableEl = fixture.debugElement.query(
      By.css('.multipleSortTreeTable')
    );
  ...
  it('should single select', () => {
    ...
    const handleRowClickSpy = spyOn(
      singleSelectionTreeTable,
      'handleRowClick'
    ).and.callThrough();
    const singleSelectionTreeTableEl = fixture.debugElement.query(
      By.css('.singleSelectionTreeTable')
    );
  ...
  it('should multiple select', () => {
    ...
    const singleSelectionTreeTableEl = fixture.debugElement.query(
      By.css('.multipleSelectionTreeTable')
    );
    let rowEls = singleSelectionTreeTableEl.queryAll(By.css('tr'));
    rowEls[1].nativeElement.click();
    fixture.detectChanges();
  ...
  it('should select with checkbox', () => {
    ...
    const checkboxSelectionTreeTableEl = fixture.debugElement.query(
      By.css('.checkboxSelectionTreeTable')
    );
    let checkboxEls = checkboxSelectionTreeTableEl.queryAll(
      By.css('.p-checkbox')
    );
    ...
    expect(
      checkboxEls[1].query(By.css('.p-checkbox-box')).nativeElement.className
    ).toContain('p-focus');
    checkboxEls[1]
      .query(By.css('input'))
  ...
  it('should select childs with checkbox', () => {
    ...
    let toggleEls = checkboxSelectionTreeTableEl.queryAll(
      By.css('.p-treetable-toggler')
    );
    toggleEls[0].nativeElement.click();
    fixture.detectChanges();
  ...
  it('should select with headerCheckbox', () => {
    ...
    checkboxEls = checkboxSelectionTreeTableEl.queryAll(By.css('.p-checkbox'));
    expect(
      checkboxEls[0].query(By.css('.p-checkbox-box')).nativeElement.className
    ).toContain('p-focus');
    checkboxEls[0]
      .query(By.css('input'))
      .nativeElement.dispatchEvent(new Event('blur'));
  ...
  it('should open cell and close', () => {
    ...
    const editableTreeTableEl = fixture.debugElement.query(
      By.css('.editableTreeTable')
    );
    ...
    expect(editableColumns[0].nativeElement.className).toContain(
      'p-cell-editing'
    );
    fixture.detectChanges();
    ...
    expect(editableColumns[0].nativeElement.className).not.toContain(
      'p-cell-editing'
    );
  });
  ...
  it('should open cell and close with tab escape and enter key', () => {
    ...
    let inputEl = editableTreeTableEl.query(By.css('input'));
    expect(inputEl).toBeTruthy();
    expect(editableColumns[1].nativeElement.className).toContain(
      'p-cell-editing'
    );
    fixture.detectChanges();
    ...
    editableColumns = editableTreeTableEl.queryAll(By.css('td'));
    expect(editableColumns[1].nativeElement.className).not.toContain(
      'p-cell-editing'
    );
    expect(editableColumns[2].nativeElement.className).toContain(
      'p-cell-editing'
    );
    ...
    editableColumns = editableTreeTableEl.queryAll(By.css('td'));
    expect(editableColumns[2].nativeElement.className).not.toContain(
      'p-cell-editing'
    );
    expect(editableColumns[3].nativeElement.className).toContain(
      'p-cell-editing'
    );
    ...
    expect(editableColumns[3].nativeElement.className).not.toContain(
      'p-cell-editing'
    );
    expect(editableColumns[2].nativeElement.className).toContain(
      'p-cell-editing'
  ...
  it('should create scrollable body and view', () => {
    ...
    const basicScrollTableEl = fixture.debugElement.query(
      By.css('.basicScrollTable')
    );
    const scrollEl = basicScrollTableEl.query(
      By.css('.p-treetable-scrollable-body')
    );
    const scrollBody = basicScrollTableEl.query(
      By.css('.p-treetable-scrollable-view')
    );
    fixture.detectChanges();
  ...
  it('should resize (Fit Mode)', () => {
    ...
    const resizableTreeTableEl = fixture.debugElement.query(
      By.css('.resizableTreeTable')
    );
  ...
  it('should reorder -1', () => {
    ...
    const reorderableTreeTableEl = fixture.debugElement.query(
      By.css('.reorderableTreeTable')
    );
    ...
    expect((reorderableTreeTable.draggedColumn as any).textContent).toEqual(
      ' Name '
    );
    dragEvent.initEvent('dragenter', true, true);
  ...
  it('should open contextMenu (separate)', () => {
    ...
    const contextMenu = fixture.debugElement.query(By.css('.p-contextmenu'))
    ...
    expect(contextMenuTreeTable.contextMenuSelection.data.name).toEqual(
      'Applications'
    );
  });
  ...
  it('should filter global and show 6 item ', async(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      const bodyRows = tableEl
        .query(By.css('.p-treetable-tbody'))
        .queryAll(By.css('tr'));
