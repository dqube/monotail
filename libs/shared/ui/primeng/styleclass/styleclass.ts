      ...
      if (!this.animating) {
        ...
        if (this.enterActiveClass === 'slidedown') {
          ...
          (this.target as HTMLElement).style.maxHeight =
            (this.target as HTMLElement).scrollHeight + 'px';
        ...
        this.enterListener = this.renderer.listen(
          ...
          () => {
            DomHandler.removeClass(
              this.target,
              this.enterActiveClass as string
            );
      ...
      if (!this.animating) {
        ...
        this.leaveListener = this.renderer.listen(
          ...
          () => {
            DomHandler.removeClass(
              this.target,
              this.leaveActiveClass as string
            );
    ...
    if (!this.documentClickListener) {
      this.documentClickListener = this.renderer.listen(
        ...
        (event) => {
          if (
            !this.isVisible() ||
            getComputedStyle(this.target as HTMLElement).getPropertyValue(
              'position'
            ) === 'static'
          )
            this.unbindDocumentClickListener();
