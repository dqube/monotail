...
@Component({
  template: `<p-autoComplete
    ...
    <p-autoComplete
      ...
      (completeMethod)="filterBrandsWithField($event)"
    ></p-autoComplete> `,
})
...
describe('AutoComplete', () => {
  ...
  it('should disabled', () => {
    ...
    const inputDefaultEl = fixture.debugElement.query(
      By.css('input')
    ).nativeElement;
    ...
    autocomplete.cd.detectChanges();
    const inputMultipleEl = fixture.debugElement
      .query(By.css('ul'))
      .query(By.css('input'));
  ...
  it('should display dropdown icon', () => {
    ...
    const dropdownIconEl = fixture.debugElement.query(
      By.css('.p-autocomplete-dropdown')
    ).nativeElement;
  ...
  it('should show filtered brands and change autoZIndex', fakeAsync(() => {
    ...
    const handleSuggestionsChangeSpy = spyOn(
      autocomplete,
      'handleSuggestionsChange'
    ).and.callThrough();
    const filterBrandsSpy = spyOn(
      testComponent,
      'filterBrands'
    ).and.callThrough();
  ...
  it('should change appendTo(2)', fakeAsync(() => {
    autocomplete.appendTo = fixture.debugElement.query(
      By.css('a')
    ).nativeElement;
    fixture.detectChanges();
  ...
  it('should show emptyMessage', fakeAsync(() => {
    ...
    expect(suggestionsEls.length).toEqual(1);
    expect(testComponent.filteredBrands.length).toEqual(0);
    expect(suggestionsEls[0].nativeElement.textContent).toContain(
      autocomplete.emptyMessage
    );
    flush();
  }));
  ...
  it('should use field', fakeAsync(() => {
    ...
    const inputEl = fixture.debugElement
      .queryAll(By.css('p-autoComplete'))[1]
      .query(By.css('.p-inputtext.p-component'));
    inputEl.nativeElement.dispatchEvent(new Event('focus'));
    inputEl.nativeElement.focus();
    inputEl.nativeElement.click();
    fixture.detectChanges();
    ...
    const firstItemEl = fixture.debugElement
      .queryAll(By.css('p-autoComplete'))[1]
  ...
  it('should multiple', () => {
    ...
    expect(listEl.nativeElement.className).toContain(
  ...
  it('should select item with multiSelect', fakeAsync(() => {
    ...
    inputEl.nativeElement.dispatchEvent(new Event('change'));
    const firstItemEl = fixture.debugElement.queryAll(By.css('li'))[1]
      .nativeElement;
    firstItemEl.click();
    fixture.detectChanges();
  ...
  it('should delete item with icon', fakeAsync(() => {
    ...
    const iconEl = fixture.debugElement.query(
      By.css('.p-autocomplete-token-icon')
    );
