...
@Component({
  ...
  template: `
      ...
      >
        ...
        <ng-container *ngIf="value === false">
          ...
          <ng-container *ngIf="!checkboxFalseIcon">
            <TimesIcon
              [styleClass]="'p-checkbox-icon'"
              *ngIf="!uncheckIconTemplate"
            />
            <span class="p-checkbox-icon" *ngIf="uncheckIconTemplate">
              <ng-template
                *ngTemplateOutlet="uncheckIconTemplate"
              ></ng-template>
            </span>
          </ng-container>
        </ng-container>
    ...
    <label
      ...
      (click)="onClick($event, input)"
      [ngClass]="{
        'p-checkbox-label-active': value != null,
        'p-disabled': disabled,
...
export class TriStateCheckbox implements ControlValueAccessor {
   ...
   * @group Emits
   */
  @Output() onChange: EventEmitter<TriStateCheckboxChangeEvent> =
    new EventEmitter<TriStateCheckboxChangeEvent>();
