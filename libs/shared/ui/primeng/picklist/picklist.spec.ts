  ...
  template: `<p-pickList [source]="sourceCars" [target]="targetCars">
    <ng-template let-car pTemplate="item">
      <div class="p-clearfix">
        <img
          src="https://primefaces.org/cdn/@primeng/images/demo/car/{{
            car.brand
          }}.png"
...
describe('PickList', () => {
  ...
  it('should call moveUp', () => {
    ...
    expect(sourceListItemsAfterChange[2].nativeElement.className).toContain(
      'p-highlight'
    );
    expect(sourceListItemsAfterChange[2].nativeElement.textContent).toContain(
      'BMW'
    );
    expect(sourceListItemsAfterChange[3].nativeElement.textContent).toContain(
      'Renault'
    );
  });
  ...
  it('should call moveDown', () => {
    ...
    expect(sourceListItemsAfterChange[4].nativeElement.className).toContain(
      'p-highlight'
    );
    expect(sourceListItemsAfterChange[4].nativeElement.textContent).toContain(
      'BMW'
    );
    expect(sourceListItemsAfterChange[3].nativeElement.textContent).toContain(
      'Mercedes'
  ...
  it('should call movetop', () => {
    ...
    expect(sourceListItemsAfterChange[0].nativeElement.className).toContain(
      'p-highlight'
    );
    expect(sourceListItemsAfterChange[0].nativeElement.textContent).toContain(
      'BMW'
    );
    expect(sourceListItemsAfterChange[3].nativeElement.textContent).toContain(
      'Renault'
  ...
  it('should call moveBottom', () => {
    ...
    expect(sourceListItemsAfterChange[9].nativeElement.className).toContain(
      'p-highlight'
    );
    expect(sourceListItemsAfterChange[9].nativeElement.textContent).toContain(
      'BMW'
    );
    expect(sourceListItemsAfterChange[3].nativeElement.textContent).toContain(
      'Mercedes'
  ...
  it('should call moveRight', () => {
    ...
    expect(targetListItemsAfterChange[0].nativeElement.textContent).toContain(
      'BMW'
    );
