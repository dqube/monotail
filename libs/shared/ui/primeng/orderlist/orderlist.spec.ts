...
describe('OrderList', () => {
  ...
  it('should created by default', () => {
    ...
    const controlEls = fixture.debugElement.query(
      By.css('.p-orderlist-controls')
    );
    const containerEl = fixture.debugElement.query(
      By.css('.p-orderlist-list-container')
    );
  ...
  it('should call moveUp', () => {
    ...
    expect(bmwEl.nativeElement.className).toContain('p-highlight');
    expect(
      itemListEl.queryAll(By.css('.p-orderlist-item'))[3].nativeElement
        .textContent
    ).toContain('Renault');
    expect(
      itemListEl.queryAll(By.css('.p-orderlist-item'))[2].nativeElement
        .textContent
    ).toContain('BMW');
  });
  ...
  it('should call moveDown', () => {
    ...
    expect(
      itemListEl.queryAll(By.css('.p-orderlist-item'))[4].nativeElement
        .textContent
    ).toContain('BMW');
  });
  ...
  it('should call MoveTop', () => {
    ...
    expect(
      itemListEl.queryAll(By.css('.p-orderlist-item'))[0].nativeElement
        .textContent
    ).toContain('BMW');
  });
  ...
  it('should call moveBottom', () => {
    ...
    expect(
      itemListEl.queryAll(By.css('.p-orderlist-item'))[9].nativeElement
        .textContent
    ).toContain('BMW');
  });
