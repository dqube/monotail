      ...
      <ng-template pTemplate="rowexpansion" let-rowData let-columns="columns">
        <tr>
          <td [attr.colspan]="columns.length + 1">
            <div
              class="p-grid p-fluid expandedRow"
...
describe('Table', () => {
  ...
  it('should display 10 rows', () => {
    ...
    const bodyRows = tableEl
      .query(By.css('.p-datatable-tbody'))
      .queryAll(By.css('tr'));
  ...
  it('should use paginator and list 5 elements', () => {
    ...
    const pageTwoEl = fixture.debugElement
      ...
      .query(By.css('.p-paginator-pages')).children[1];
  ...
  it('should select with radioButton', () => {
    ...
    expect(
      vwRadioEl.query(By.css('.p-radiobutton-box')).nativeElement.className
    ).toContain('p-focus');
    vwRadioEl
      .query(By.css('input'))
  ...
  it('should select with checkbox and unselect when self click', () => {
    ...
    expect(
      vwCheckboxEl.query(By.css('.p-checkbox-box')).nativeElement.className
    ).toContain('p-focus');
    vwCheckboxEl
      .query(By.css('input'))
      .nativeElement.dispatchEvent(new Event('blur'));
  ...
  it('should select all items and unselect all item with header checkbox', () => {
    ...
    expect(
      headerCheckbox.query(By.css('.p-checkbox-box')).nativeElement.className
    ).toContain('p-focus');
  ...
  it('should close cell', () => {
    ...
    let cell = fixture.debugElement.query(By.css('.p-editable-column'));
    let editableDir = cell.parent
      .query(By.directive(EditableColumn))
      .injector.get(EditableColumn);
    cell.nativeElement.click();
    fixture.detectChanges();
  ...
  it('should open prev cell', () => {
    ...
    let editableDir = cell.parent
      .query(By.directive(EditableColumn))
      .injector.get(EditableColumn);
    const moveToPreviousCellSpy = spyOn(
      editableDir,
      'moveToPreviousCell'
    ).and.callThrough();
    const keydownEvent: any = document.createEvent('CustomEvent');
  ...
  it('should reorder row (bottom of the dropped row)', () => {
    ...
    expect(reorderableRowEls[1].children[1].nativeElement.textContent).toEqual(
      ' VW '
    );
    ...
    expect(reorderableRowEls[2].children[1].nativeElement.textContent).toEqual(
      ' VW '
    );
    expect(reorderableRowEls[3].children[1].nativeElement.textContent).toEqual(
      ' Renault '
    );
