...
describe('InputTextarea', () => {
  ...
  it('should increment height', () => {
    ...
    expect(inputTextEl.nativeElement.style.height).toBeGreaterThan(
      cachedHeight
    );
  ...
  it('should use resize with maxHeight', () => {
    ...
    expect(inputTextEl.nativeElement.style.height).toEqual(
      inputTextEl.nativeElement.style.maxHeight
    );
