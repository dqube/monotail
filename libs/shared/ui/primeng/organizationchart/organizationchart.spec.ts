...
describe('OrganizationChart', () => {
  ...
  it('should display by default', () => {
    ...
    const organizationchartEl = fixture.debugElement.query(
      By.css('.p-organizationchart')
    );
  ...
  it('should select single', () => {
    ...
    const nodeEls = fixture.debugElement.queryAll(
      By.css('.p-organizationchart-node-content')
    );
