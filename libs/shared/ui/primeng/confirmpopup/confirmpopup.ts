  ...
  template: `
    ...
    >
      ...
      <div class="p-confirm-popup-footer">
        ...
        >
          <i
            [class]="confirmation.rejectIcon"
            *ngIf="confirmation.rejectIcon; else rejecticon"
          ></i>
          <ng-template
            #rejecticon
            *ngTemplateOutlet="rejectIconTemplate"
          ></ng-template>
        </button>
        <button
          type="button"
        ...
        >
          <i
            [class]="confirmation.acceptIcon"
            *ngIf="confirmation.acceptIcon; else accepticon"
          ></i>
          <ng-template
            #accepticon
            *ngTemplateOutlet="acceptIconTemplate"
          ></ng-template>
        </button>
      </div>
    </div>
...
export class ConfirmPopup implements AfterContentInit, OnDestroy {
  ...
  align() {
    ...
    (this.container as HTMLDivElement).style.setProperty(
      '--overlayArrowLeft',
      `${arrowLeft}px`
    );
