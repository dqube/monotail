...
describe('Paginator', () => {
  ...
  it('should have a 5 page link, 4 paginator element and 1 dropdown with 3 option', () => {
    ...
    const updatePaginatorStateSpy = spyOn(
      paginator,
    ...
    const dropdownEl = fixture.debugElement.query(By.css('p-dropdown'));
    const paginatorElemntEls = fixture.debugElement.queryAll(
      By.css('.p-paginator-page')
    );
  ...
  it('should called onPageLinkClick and go to clicked page', () => {
    ...
    const onPageLinkClickSpy = spyOn(
      paginator,
      'onPageLinkClick'
    ).and.callThrough();
    fixture.detectChanges();
    ...
    const pageElsAfterClick = fixture.debugElement.queryAll(
      By.css('.p-paginator-page')
    );
    const activePage = fixture.debugElement.query(By.css('.p-highlight'));
    expect(onPageLinkClickSpy);
    expect(activePage.nativeElement.textContent.replace(/\s+/g, '')).toEqual(
      '4'
    );
    expect((paginator.getPage() + 1).toString().replace(/\s+/g, '')).toEqual(
      pickedPage.nativeElement.textContent.replace(/\s+/g, '')
    );
  ...
  it('should called changePageToNext and go to next page', () => {
    ...
    const changePageToNextSpy = spyOn(
      paginator,
      'changePageToNext'
    ).and.callThrough();
    fixture.detectChanges();
    ...
    expect((paginator.getPage() + 1).toString().replace(/\s+/g, '')).toEqual(
      nextPageEl.nativeElement.textContent.replace(/\s+/g, '')
    );
  ...
  it('should called changePageToPrev and go to prev page', () => {
    ...
    const changePageToPrevSpy = spyOn(
      paginator,
      'changePageToPrev'
    ).and.callThrough();
    fixture.detectChanges();
    ...
    expect((paginator.getPage() + 1).toString().replace(/\s+/g, '')).toEqual(
      prevPageEl.nativeElement.textContent.replace(/\s+/g, '')
    );
    let pageValue = paginator.getPage() + 1;
    for (let link of paginator.pageLinks) {
      expect(link).toEqual(pageValue);
  ...
  it('should called changePageToLast and go to last page', () => {
    ...
    const changePageToLastSpy = spyOn(
      paginator,
      'changePageToLast'
    ).and.callThrough();
    fixture.detectChanges();
  ...
  it('should called changePageToFirst and go to first page', () => {
    ...
    const changePageToFirstSpy = spyOn(
      paginator,
      'changePageToFirst'
    ).and.callThrough();
    fixture.detectChanges();
    ...
    const pageLastEl = fixture.debugElement.query(By.css('.p-paginator-last'));
    const pageFirstEl = fixture.debugElement.query(
      By.css('.p-paginator-first')
    );
    pageLastEl.nativeElement.click();
    fixture.detectChanges();
  ...
  it('should called onRppChange and change page count', () => {
    ...
    fixture.detectChanges();
    const dropdownItemsEl = fixture.debugElement.queryAll(
      By.css('.p-dropdown-item')
    );
